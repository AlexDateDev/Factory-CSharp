...
//    /// V.1.0
//    /// </summary>
//    public partial class FactoryEmail
//    {
...
//        public FactoryEmail( string emailRemitenteRFC,
//                            string serverSMTP,
//                            string usuarioSMTP,
//                            string pswSMTP,
//                            int? port = null,
...
//                // User SMTP
//                if( !FactoryString.IsEmpty( usuarioSMTP ) && !FactoryString.IsEmpty( pswSMTP ) ) {
...
//        {
//            if( !FactoryValidate.IsEmail( email ) ) {
//                throw new Exception( "La dirección de correo TO no es un email válido (FactoryMail: AddTo)" );
//            }
